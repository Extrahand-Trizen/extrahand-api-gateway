...
export class TaskController {
  ...
  async getRescheduleEligibility(
    ...
    try {
      ...
      const response = await taskService.getTaskRescheduleEligibility(
        req.params.taskId,
        req.user,
      );
      res.status(response.status).json(response.data);
    } catch (error) {
      handleServiceError(error, res, "TaskController.getRescheduleEligibility");
    }
  }
  ...
  async getRescheduleSlots(
    ...
    try {
      ...
      const response = await taskService.getTaskRescheduleSlots(
        req.params.taskId,
      ...
      handleServiceError(error, res, "TaskController.getRescheduleSlots");
    }
  }
  ...
  async rescheduleTask(
    ...
    try {
      ...
      const response = await taskService.rescheduleTaskVisit(
        req.params.taskId,
        req.body,
        req.user,
      );
      ...
      handleServiceError(error, res, "TaskController.rescheduleTask");
    }
  }
  ...
  async getStartOtp(
    ...
    try {
      ...
      const response = await taskService.getStartOtp(taskId, req.user);
      ...
      res.status(response.status).json({
        success: true,
        code: response.status,
        message: body?.message || "Start OTP retrieved",
        data: payload,
      });
    } catch (error) {
      handleServiceError(error, res, "TaskController.getStartOtp");
    }
  }
  ...
  async markExecutionArrived(
    ...
    try {
      ...
      res.status(response.status).json({
        success: true,
        code: response.status,
        message: taskServiceResponse?.message || "Marked as arrived",
        data: enrichedTask,
      });
    } catch (error) {
